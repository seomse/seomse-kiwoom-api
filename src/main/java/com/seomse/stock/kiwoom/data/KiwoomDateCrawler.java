...
public class KiwoomDateCrawler extends Service {

    private static final Logger logger = getLogger(KiwoomDateCrawler.class);
    ...
    private void getItemCodeList(){
        itemList = JdbcQuery.getStringList("SELECT ITEM_CD FROM T_STOCK_ITEM WHERE TRADE_FG = 'Y'");
    ...
    public static void main(String [] args){
        new KiwoomDateCrawler().crawlStart("20200727");
    }
}
